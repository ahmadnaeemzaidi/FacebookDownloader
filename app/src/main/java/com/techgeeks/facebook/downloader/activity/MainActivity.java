...
import com.techgeeks.facebook.downloader.databinding.ActivityMainBinding;
import com.techgeeks.facebook.downloader.util.Ads;
import com.techgeeks.facebook.downloader.util.AppLangSessionManager;
import com.techgeeks.facebook.downloader.util.ClipboardListener;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initViews() {
        ...
        binding.rvChangeLang.setOnClickListener(v -> {
            ...
            final TextView tvChinese = dialogSortBy.findViewById(R.id.tvChinese);
            dialogSortBy.show();
            ...
            tvChinese.setOnClickListener(view -> {
                setLocale("zh");
                appLangSessionManager.setLanguage("zh");
            });
